<div class="min-h-screen bg-gray-50 dark:bg-gray-900 p-6">
                            ...
                            <td
                                ...
                                <div class="flex items-center justify-center">
                                    <div class="flex items-center space-x-3">
                                        <!-- Toggle Switch -->
                                        <button type="button" wire:click="toggleCommandStatus({{ $cd->id }})"
                                            ...
                                            role="switch" aria-checked="{{ $cd->status ? 'true' : 'false' }}"
                                            aria-label="Toggle company status">
                                            <span
                                                class="inline-block h-3 w-3 transform rounded-full bg-white shadow-sm transition-all duration-200 ease-in-out {{ $cd->status ? 'translate-x-4' : 'translate-x-1' }}"></span>
                                        </button>
                                    </div>
                                </div>
                            </td>
            ...
            <div class="bg-white dark:bg-gray-800 px-6 py-3 border-t border-gray-200 dark:border-gray-700 rounded-b-lg">
                <div class="flex items-center justify-between">
                    <div class="text-sm text-gray-700 dark:text-gray-300">
                        Mostrando {{ $commands->firstItem() }} a {{ $commands->lastItem() }} de {{ $commands->total() }}
                        resultados
                    </div>
                    <div>
                        {{ $commands->links() }}
        ...
        <div class="relative min-h-screen flex items-center justify-center p-4">
            <div class="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto"
                ...
                <form wire:submit.prevent="save" class="p-6 space-y-6">
                    ...
                    <div class="mb-3">
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Ruta de Impresión
                            *</label>
    ...
    <div x-data="{ open: @entangle('confirmingCommandDeletion') }" x-show="open" style="display:none;"
        ...
        <div class="bg-white rounded shadow p-6 z-50 w-full max-w-md">
            ...
            <div class="flex justify-end space-x-2">
                ...
                <button type="button" wire:click="deleteCommand"
