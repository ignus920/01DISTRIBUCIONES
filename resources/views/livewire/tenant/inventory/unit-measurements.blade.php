<div class="min-h-screen bg-gray-50 dark:bg-gray-900 p-6">
                                ...
                                <div class="flex items-center justify-center">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <button type="button" wire:click="toggleUnitStatus({{ $ut->id }})"
                                            ...
                                            role="switch" aria-checked="{{ $ut->status ? 'true' : 'false' }}"
                                            aria-label="Toggle company status">
                                            <span
                                                class="inline-block h-3 w-3 transform rounded-full bg-white shadow-sm transition-all duration-200 ease-in-out {{ $ut->status ? 'translate-x-4' : 'translate-x-1' }}"></span>
                                        </button>
                                    </div>
                                </div>
                            </td>
        ...
        <div class="relative min-h-screen flex items-center justify-center p-4">
            <div class="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto"
                ...
                <form wire:submit.prevent="save" class="p-6 space-y-6">
                    ...
                    <div class="mb-3">
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Cantidad
                            *</label>
    ...
    <div x-data="{ open: @entangle('confirmingUnitDeletion') }" x-show="open" style="display:none;"
