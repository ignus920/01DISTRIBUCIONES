                                    ...
                                    <div x-data="{ 
                                        ...
                                        <div x-show="open"
                                            ...
                                            <div class="py-1" role="menu" aria-orientation="vertical">
                                                @if($item->status)
                                                    <!-- Empresa activa: mostrar acciones normales -->
                                                ...
                                                @else
                                                    <!-- Empresa desactivada: mostrar acciones deshabilitadas -->
                                                    <div class="relative group">
                                                        <button disabled
                                                            class="w-full text-left px-4 py-2 text-sm text-gray-400 dark:text-gray-500 cursor-not-allowed opacity-50 flex items-center">
                                                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                                            </svg>
                                                            Editar
                                                        ...
                                                        <!-- Tooltip -->
                                                        <div class="absolute left-full ml-2 top-1/2 transform -translate-y-1/2 px-2 py-1 text-xs text-white bg-gray-900 dark:bg-gray-700 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap z-50">
                                                            Active la empresa para editarla
                                                        </div>
                                                    </div>
                                                    <div class="relative group">
                                                        <button disabled
                                                        ...
                                                        <!-- Tooltip -->
                                                        <div class="absolute left-full ml-2 top-1/2 transform -translate-y-1/2 px-2 py-1 text-xs text-white bg-gray-900 dark:bg-gray-700 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap z-50">
                                                            Active la empresa para gestionar sucursales
                                                        </div>
                                                    </div>
                                                    <div class="relative group">
                                                        <button disabled
                                                        ...
                                                        <!-- Tooltip -->
                                                        <div class="absolute left-full ml-2 top-1/2 transform -translate-y-1/2 px-2 py-1 text-xs text-white bg-gray-900 dark:bg-gray-700 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap z-50">
                                                            Active la empresa para gestionar contactos
                                                        </div>
                                                    </div>
                                                @endif
                                            </div>
