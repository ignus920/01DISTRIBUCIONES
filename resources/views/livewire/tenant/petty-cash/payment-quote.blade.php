            ...
            <div class="flex-1 bg-white dark:bg-slate-900 flex flex-col min-h-0">
                ...
                <div class="p-6 bg-white dark:bg-slate-900 border-t border-gray-100 dark:border-slate-800 flex flex-col sm:flex-row gap-4 justify-end items-center">
                    ...
                    <button wire:click="confirmPayment()"
                        ...
                        <svg wire:loading.remove wire:target="confirmPayment" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                        
                        <!-- Texto y spinner durante carga -->
                        <svg wire:loading wire:target="confirmPayment" class="animate-spin h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
